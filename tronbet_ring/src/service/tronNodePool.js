...
function getTronWeb(nodeName) {
    ...
    } else if (nodeName == 'slave') {
        return slave_node.tronWeb
    }
    // console.log('master_node-----------------------', master_node.tronWeb)
    // console.log('slave_node-----------------------', slave_node.tronWeb)
    if (master_node.avg > 0 && master_node.avg < 999999999) { //优先使用主节点
        ...
        loggerError.error("services undifine");
    }
