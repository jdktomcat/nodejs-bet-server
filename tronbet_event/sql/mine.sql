...
CREATE TABLE tron_bet_event.mine_letter (
    `log_id` bigint(20) NOT NULL AUTO_INCREMENT,
    `addr` varchar(64) DEFAULT NULL,
    `letter_D` bigint(20) DEFAULT 0,
    `letter_I` bigint(20) DEFAULT 0,
    `letter_C` bigint(20) DEFAULT 0,
    `letter_E` bigint(20) DEFAULT 0,
    `letter_W` bigint(20) DEFAULT 0,
    `letter_N` bigint(20) DEFAULT 0,
    `letter_T` bigint(20) DEFAULT 0,
    `letter_R` bigint(20) DEFAULT 0,
    `letter_X` bigint(20) DEFAULT 0,
    `letter_K` bigint(20) DEFAULT 0,
    PRIMARY KEY (`log_id`),
