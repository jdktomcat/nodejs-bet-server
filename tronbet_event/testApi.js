...
async function testBags() {
    ...
    console.log(data.data.bags[0],data.data )
}
...
async function testexchange() {
    let {data} = await axios({
        ...
        data : {
            addr  : 'TLA8xpn9uS7Wc5rdS8LLJJvQ3WbPVaitP3',
            sign : '0xe47cq35cf499e53e23e1a66697d8cb600b69f2674f50637162e56bc2377dd7d67878f1ff79e37a9e89c027e10f4dcf436ed507ab7d2acc82a93da2dce9f80fb91b',
            num : 2,
            suit_id : 4
        },
        headers: { 'content-type': 'application/json'},
...
async function main() {
    ...
    // }
    // await testopenBox('TLA8xpn9uS7Wc5rdS8LLJJvQ3WbPVaitP3')
