...
async function getPlayerLogSingle(conn) {
    ...
    // let sql = "select * from dice_events_v2 where addr = 'THatWvn35xiuyXLc19MZHXTwRhqk56TA87' and order_id >= 16162;";
    let sql = "select * from dice_events_v2 where addr = 'TMS5ccKX5ByqKgjePix8KvtK9aMN1Bhry7' and order_id >=  4687;"
    let params = [];
